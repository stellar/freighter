    ...
    /***/ 7678: /***/ (module, exports) => {
      ...
      is.generator = (value) => {
        ...
        return (
          ...
          is.function_(
            (_b = value) === null || _b === void 0 ? void 0 : _b.throw
          )
        );
      };
      ...
      exports.assert = {
        ...
        nonEmptyStringAndNotWhitespace: (value) =>
          assertType(
            is.nonEmptyStringAndNotWhitespace(value),
            "non-empty string and not whitespace" /* nonEmptyStringAndNotWhitespace */,
            value
          ),
        emptyObject: (value) =>
          assertType(
...
*/
    ...
    */
      ...
      class Glob {
        ...
        constructor(pattern, opts) {
          ...
          this.patterns = matchSet.map((set, i) => {
            return new pattern_js_1.Pattern(
              set,
              globParts[i],
              0,
              this.platform
    ...
    /***/ 1477: /***/ (__unused_webpack_module, exports) => {
      "use strict";
    ...
    /***/ 266: /***/ function (
      ...
      const filter = (pattern, options = {}) => (p) =>
          ...
          for (
            ...
            switch (c) {
              ...
              case "[":
                ...
                brace_expressions_js_1.parseClass)(pattern, i);
                if (consumed) {
                  re += src;
    ...
    /***/ 9820: /***/ (__unused_webpack_module, exports) => {
      "use strict";
