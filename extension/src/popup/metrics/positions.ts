 ...
 *
 * The top of the positions-to-deposit funnel. Everything downstream of the
 * sheet's Deposit button is an `earn.*` event carrying `source:
 * "position_row"`, which is what joins the two halves.
 *
