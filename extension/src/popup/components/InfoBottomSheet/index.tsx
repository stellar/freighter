...
export const InfoSheetContent = ({
  ...
  return (
    ...
    >
      ...
      {/* Do not pass a className to this Button. SDS Button does
          `className: \`Button ...\`, ...props`, so a passed className
          overwrites its own variant/size classes and the button renders as
          bare text. */}
      <Button
        size="lg"
        variant="secondary"
