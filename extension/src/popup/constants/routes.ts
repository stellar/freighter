export enum ROUTES {
  ...
  swap = "/account/swap",
  swapAmount = "/account/swap/amount",
  swapSettings = "/account/swap/settings",
  swapSettingsFee = "/account/swap/settings/fee",
  swapSettingsSlippage = "/account/swap/settings/slippage",
  swapConfirm = "/account/swap/confirm",
