...
test.describe("BlockAid Scan - Suspicious States", () => {
  ...
  test.skip("Add asset shows suspicious warning when scan detects suspicious asset", async ({
    page,
    extensionId,
  }) => {
    test.slow();
  ...
  test.skip("Send payment shows suspicious warning when scan detects suspicious transaction", async ({
    page,
    extensionId,
  }) => {
    test.slow();
  ...
  test.skip("Swap shows suspicious warning when scan detects suspicious tokens", async ({
    page,
    extensionId,
  }) => {
    test.slow();
